    ...
    return (
      <input
        ...
        className={cn(
          ...
          // auto-zooms the page on focus for any text input under 16px,
          // which is jarring and can leave the layout stuck zoomed in
          // after blur. globals.css backs this up for any input that
          // doesn't go through this component.
